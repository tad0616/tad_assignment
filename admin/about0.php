...
$about_admin->addInfoBoxLine($xoopsModule->getVar('name'), '', 'xoopsfoundation@gmail.com', '', 'module');
$about_admin->addInfoBoxLine(_AM_XDIR_ABOUT_MODULE_INFO, $module_info, '', '', 'information');
//$about_admin->addChangelogLabel(_AM_XDIR_ABOUT_CHANGELOG);

//echo $about_admin->displayNavigation('about.php');
$about_admin->displayNavigation(basename(__FILE__));
//echo $about_admin->renderabout();
$about_admin->displayAbout(false);
