      ...
      <{foreach from=$all_data item=as}>
        <tr>
          ...
          <td>
            ...
            <a href="../post.php?op=tad_assignment_form&assn=<{$as.assn}>" class="btn btn-sm btn-xs btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i>  <{$smarty.const._TAD_EDIT}></a>
          </td>
        </tr>
      <{/foreach}>
