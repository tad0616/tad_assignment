...
<div class="container-fluid">
  ...
  <form action="add.php" method="post" id="myForm" name="myForm" enctype="multipart/form-data" class="form-horizontal" role="form">
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-sm-8"><input type="text" name="title" value="<{$title|default:''}>" class="form-control" placeholder="<{$smarty.const._MA_TADASSIGN_TITLE}>"></div>

    </div>

    <div class="form-group row mb-3">
      <label class="col-sm-2 col-form-label text-sm-right control-label"><{$smarty.const._MA_TADASSIGN_PASSWD}></label>
      <div class="col-sm-3"><input type="text" name="passwd" class="form-control" value="<{$passwd|default:''}>" placeholder="<{$smarty.const._MA_TADASSIGN_PASSWD}>"></div>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-sm-8"><textarea name="note"  class="form-control" rows=4 placeholder="<{$smarty.const._MA_TADASSIGN_NOTE}>"><{$note|default:''}></textarea></div>
    </div>

    <div class="form-group row mb-3">
      <label class="col-sm-2 col-form-label text-sm-right control-label"><{$smarty.const._MA_TADASSIGN_START_DATE}></label>
      <div class="col-sm-3"><{$start_date_form|default:''}></div>
      <label class="col-sm-2 col-form-label text-sm-right control-label"><{$smarty.const._MA_TADASSIGN_END_DATE}></label>
      <div class="col-sm-3"><{$end_date_form|default:''}></div>
    </div>
