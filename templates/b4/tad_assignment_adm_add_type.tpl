<link href="<{$xoops_url}>/modules/tadtools/css/font-awesome/css/font-awesome.css" rel="stylesheet">
  ...
  <form action="add_type.php" method="post" id="myForm" name="myForm" enctype="multipart/form-data" role="form">
  ...
  <{foreach from=$all item=data}>
    <tr>
        <td>
          <a href="javascript:delete_func('<{$data.$type}>');" class="btn btn-sm btn-danger"><{$smarty.const._TAD_DEL}></a>
          <{$data.type}>
        </td>
    </tr>
  <{/foreach}>
